    ...
    <body class="text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                ...
                <!-- Resolucao da Cadastro de Aluno -->

                <form action="../JogoMemoria/respcadaluno.php" method="post"> 
                    <div class="container register">
                        <div class="row">
                            <div class="col-md-12 register-right">
                                <br>
                                <div class="tab-content" id="myTabContent">
                                    <h4 class="register-heading">Bem vindo, Aluno!<br>Por favor, insira suas
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control" required
                                                       placeholder="Primeiro Nome" name="nome" id="nomealuno"/>
                                            </div>
                                            <div class="form-group">
                                                <input type="text" class="form-control" required
                                                       placeholder="Último Nome" name="sobrenome" id="sobrenomealuno"/>
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control" required
                                                       placeholder="Senha" id="senhaaluno" name="senha"/>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" minlength="8" maxlength="10" class="form-control"
                                                       placeholder="R.A" required name="ra" id="raaluno"/>
                                            </div>

                                            <div class="form-group">
                                                <input type="password" class="form-control" required
                                                       placeholder="Preencha a senha novamente" id="senhaaluno2" onblur="verificaSenhaAluno()"/>
                                            </div>
                                        
                                        </div>
                                        
                                        <div class="btn-cadprof">
                                            <input class="btn btn-light" id="cadaluno" type="submit"
                                                   value="Cadastrar">
                                        </div>

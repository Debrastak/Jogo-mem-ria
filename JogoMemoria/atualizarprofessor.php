            ...
            <main role="main" class="inner cover">
                <blockquote class="cabecalho-log-aluno">
                    <div class="titulo-login-aluno">
                        Bem vindo a área de atualização de senha!
                    </div>
                    <br />
                </blockquote>

                <!-- Area de Atualizacao do Usuario-->
                <div class="container">
                    <div class="d-flex justify-content-center h-100">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Resolucao da Alteracao de Professor -->

                                <form action="../JogoMemoria/respalteraprofessor.php" method="post" >

                                    <div class="input-group form-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-user"></i></span>
                                        </div>
                                        <input type="text" class="form-control" required maxlength="100" placeholder="Informa o R.A aqui:"  name="ra">
                                        </input>
                                    </div>
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input type="password" class="form-control" required maxlength="20"
                                               placeholder="Informe a senha antiga aqui" name="senha1"> </input>
                                    </div>
                                    ...
                                    <div class="input-group form-group">
                                        ...
                                        <input type="password" class="form-control" required maxlength="20"
                                               placeholder="Informe a senha nova aqui" name="senha2"></input>
                                    </div>
                                    <div class="btn-login">
                                        <input type="submit" class="btn btn-dark" value="Alterar"></input>
                                    </div>

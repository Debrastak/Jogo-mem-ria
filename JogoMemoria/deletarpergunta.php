                ...
                <nav class="navbar navbar-default navbar-fixed">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="dashboardprofessor.php">Delecao de Questoes</a>
                        </div>
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="header">
                                     ...
                                     <!-- Resolucao da Delecao de Pergunta -->

                                        <form action="../JogoMemoria/respcadperguntadeletar.php" method="post"> 

                                            <label>Informe o ID da questao a ser deletada:</label>

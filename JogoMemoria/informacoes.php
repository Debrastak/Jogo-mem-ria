...
Milena Basso - RA: 20956610 -->
    <head>
        ...
        <title>Informações · Jogo da Memória</title>
    ...
    <body class="text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <p>
                    Site realizado por Erik Kaue Paroline, Fernanda Umberto, Guilherme Rodrigues, Matheus Marques e Milena Basso. Que tem como objetivo, demonstrar um CRUD e um jogo da memória.

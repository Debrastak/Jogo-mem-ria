...
<html lang="en">
    <head>
        ...
        <title>Homepage · Jogo da Memória</title>
    ...
    <body class="text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <h1 class="home-titulo">Bem-vindo ao site de Jogo da Memória</h1>
                <br>
                <a href=escolherlogin.php class="btn btn-lg btn-secondary">Clique aqui para entrar</a>
                </p>
            </main>

...
Milena Basso - RA: 20956610 -->
    <head>
        ...
        <title>Sou professor · Jogo da Memória</title>
    ...
    <body class="text-center">
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main role="main" class="inner cover">
                <div>
                    <blockquote class="cabecalhologaluno">
                        <div class="titulo-login-professor">
                            Bem vindo a área de login dos professores
                        </div>
                    </blockquote>
                </div>
                <br />
                    ...
                    <div class="d-flex justify-content-center h-100">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="../JogoMemoria/respconsultaprofessor.php" method="post" >
                            ...
                            <div class="card-footer">
                                <div class="d-flex justify-content-center links">
                                    Não possui uma conta?&nbsp;<a href="cadastroprofessor.php">Cadastrar-se</a>
                                </div>
                                <div class="d-flex justify-content-center">
                                    <a href="atualizarprofessor.php">Esqueceu sua senha?</a>
                                </div>
                            </div>
                        </div>
                    </div>

            ...
            <main role="main" class="inner cover">
                <blockquote class="cabecalho-log-aluno">
                    <div class="titulo-login-aluno">
                        Bem vindo a área de delecao de conta de professores.
                    </div>
                    <br />
                </blockquote>
                    ...
                    <div class="d-flex justify-content-center h-100">
                        <div class="card">
                            <div class="card-body">
                             ...
                             <!-- Resolucao da Delecao de Professor -->

                                <form action="../JogoMemoria/respdeletaprofessor.php" method="post" >
                                    ...
                                    <br />
                                    <div class="btn-login">
                                        <input type="submit" value="Deletar Conta" class="btn btn-dark"></input>
                                    </div>
                                </form>
